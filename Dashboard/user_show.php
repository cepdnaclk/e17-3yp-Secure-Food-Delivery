<?php
    ...
    if (isset($_SESSION['token'])) {
        ...
        $url = 'https://35.171.26.170/api/admin/list/customers';
        $curl = curl_init($url);
        ...
        if($httpcode == 200){
            ...
            for($i = 0; $i < sizeof($obj); $i++){
                $temp .= "<tr>";
                $temp .= "<td class='details'>" . $obj[$i]["cName"] ."</td>";
                $temp .= "<td>". $obj[$i]["mobNo"] ."</td>";
                $temp .= "<td>". $obj[$i]["cAddress"] ."</td>";
                $temp .= "</tr>";
            }
        }
    }
...
<head>
    <meta charset="utf-8">
    <title>SFD | Show Customers</title>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3" style="font-size: 20px;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="assign_RFID.html">Assign RFID</a>
                            </li>
    ...
    <div class="container">
        ...
        <table class="table" style="margin-top: 10rem;">
            ...
            <thead style="background-color: gray;">
                <th class="details" style="color:white">Name of the Customer</th>
