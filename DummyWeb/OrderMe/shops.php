           ...
           <div class="container">
               <div class="row">
                   <div class="col-xl-10 offset-xl-1 text-center">
                       <h1 class="text-center">Restaurents at Fingertips</h1>
                   </div> <!-- end of col -->
               </div> <!-- end of row -->
           </div> <!-- end of container -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="team-image">
                            <a href="restaurent1.php"><img src="images/shop1/shop1.jpg" alt="Team"></a>
                        </div>
                        <div class="team-content">
                            <h5 class="holder-name">Food Paradise</h5>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="team-image">
                            <a href="restaurent2.php"><img src="images/shop2/shop2.jpg" alt="Team"></a>
                        </div>
                        <div class="team-content">
                            <h5 class="holder-name">Hotel Peradeniya</h5>
                            <p class="text">Peradeniya</p>
                        </div>
                    </div> <!-- single member -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="team-image">
                            <a href="restaurent3.php"><img src="images/shop3/shop3.jpg" alt="Team"></a>
                        </div>
                        <div class="team-content">
                            <h5 class="holder-name">Kandyan Foods</h5>
                            <p class="text">Kandy</p>
                        </div>
                    </div> <!-- single member -->
                </div>
