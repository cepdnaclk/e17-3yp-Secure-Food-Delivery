...
<!doctype html>
   ...
   <head>
       ...
       <title>Hotel Peradeniya | OrderMe</title>
           ...
           <div class="container">
               <div class="row">
                   <div class="col-xl-10 offset-xl-1 text-center">
                       <h1 class="text-center">Hotel Peradeniya</h1>
                   </div> <!-- end of col -->
               </div> <!-- end of row -->
           </div> <!-- end of container -->
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="team-image">
                            <a href="purchase.php?id=2.1"><img src="images/shop2/chickenpizza.png" alt="Team"></a>
                        </div>
                        <div class="team-content">
                            <h5 class="holder-name">Chicken Pizza</h5>
                            <p class="text">Rs.1450</p>
                        </div>
                    </div> <!-- single member -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="team-image">
                            <a href="purchase.php?id=2.2"><img src="images/shop2/cheesepizza.png" alt="Team"></a>
                        </div>
                        <div class="team-content">
                            <h5 class="holder-name">Cheese Pizza</h5>
                            <p class="text">Rs.1600</p>
                        </div>
                    </div> <!-- single member -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="team-image">
                            <a href="purchase.php?id=2.3"><img src="images/shop2/sausagepizza.png" alt="Team"></a>
                        </div>
                        <div class="team-content">
                            <h5 class="holder-name">Sausage Pizza</h5>
                            <p class="text">Rs.1800</p>
                        </div>
                    </div> <!-- single member -->
                </div>
            </div> <!-- row -->
