...
<!doctype html>
   ...
   <head>
       ...
       <title>Food Paradise | OrderMe</title>
           ...
           <div class="container">
               <div class="row">
                   <div class="col-xl-10 offset-xl-1 text-center">
                       <h1 class="text-center">Food Paradise Kandy</h1>
                   </div> <!-- end of col -->
               </div> <!-- end of row -->
           </div> <!-- end of container -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="team-image">
                            <a href="purchase.php?id=1.1"><img src="images/shop1/chickenrice.jpg" alt="Team"></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="team-image">
                            <a href="purchase.php?id=1.2"><img src="images/shop1/chickenkottu.jpg" alt="Team"></a>
                        </div>
                        <div class="team-content">
                            <h5 class="holder-name">Chicken Kottu</h5>
                            <p class="text">Rs.600</p>
                        </div>
                    </div> <!-- single member -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="team-image">
                            <a href="purchase.php?id=1.3"><img src="images/shop1/chickenpasta.png" alt="Team"></a>
                        </div>
                        <div class="team-content">
                            <h5 class="holder-name">Chicken Pasta with Cheese</h5>
                            <p class="text">Rs.800</p>
                        </div>
                    </div> <!-- single member -->
                </div>
            </div> <!-- row -->
