<?php 
    ...
    $query = "select orderid,CTelNo,details,sfd from placeorder where restaurent='{$restaurent}' and _date='{$date}'"; 
    ...
    if($execute){
        while($order = mysqli_fetch_assoc($execute)){  
            ...
            $orders .= "<div class=\"col-sm text-center\"><button type=\"submit\" class=\"form-control-submit-button\" name=\"confirmOrder\" formaction=\"partnerState.php?orderID={$order['orderid']}&ctelNo={$order['CTelNo']}&sfd={$order['sfd']}&details={$order['details']}\">Check State</button></div>";
            $orders .= "</div></div><br>";
        }
    }
        ...
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li>
                        <span class="nav-item">
                            <a class="btn-solid-sm page-scroll" href="partner.php">Confirm Orders</a>
                        </span>
                    </li>
                    <li>
                        <span class="nav-item">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1 text-center">
                    <br>
                    <h1 class="text-center">Check the current state of orders</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row" style="background-color:#80dfff; border-radius: 20px;">
                            ...
                            <div class="col-sm text-center"><p class="p-large">Status</p></div>
                        </div>
                        <br>
                        <?php echo $orders; ?>
                    </div> <!-- end of col -->
